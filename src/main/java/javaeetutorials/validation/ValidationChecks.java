...
public class ValidationChecks {
  ...
  public Response getInnError() {
    ...
    Set<ConstraintViolation<InnItem>> constraintViolations = validator.validate(inn1,
        OldType.class);
    Set<ConstraintViolation<InnItem>> constraintViolations1 = validator.validate(inn2,
        NewType.class);
  ...
  public Response methodCheck() throws NoSuchMethodException {
    ...
    Set<ConstraintViolation<InnItem>> validated = executableValidator.validateReturnValue(inn,
        createInnByCountry, new Object[]{"11"});
